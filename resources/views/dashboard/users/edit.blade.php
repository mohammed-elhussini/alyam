<x-dashboard.layout>
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid"
        ...
        <div
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"> تحرير {{$user->name}}</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="{{route('users.index')}}" class="text-muted">الأعضاء</a>
                    </li>
  ...
  <i class="ki ki-bold-close icon-xs text-muted"></i>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-lg form-control-solid @error('nationality') is-invalid @enderror"
                                           type="text"
                                           name="nationality"
                                           placeholder="الجنسية"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid @error('phone') is-invalid @enderror"
                                               name="phone"
                                               value="{{$user->phone}}"
                                               placeholder="الجوال">
                                        @error('phone')
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <div class="input-group date">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{$user->driving_license_exp}}"
                                               id="">
                            ...
                            <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-form-label col-3 text-lg-left text-left">
                                    رقم الهوية
                                </label>
                                <div class="col-9">
                                    <div class="input-group input-group-lg input-group-solid">
