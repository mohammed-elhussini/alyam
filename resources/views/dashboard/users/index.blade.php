                    ...
                    <div class="card-body text-center pt-4">
                        ...
                        <div class="mt-7">
                            <div class="symbol symbol-circle symbol-lg-75">
                                <img src="{{asset('dashboard/assets/media/users/300_14.jpg')}}" alt="image" />
                            </div>
                    ...
                    <div class="card-body text-center pt-4">
                        ...
                        <div class="mt-7 pb-2">
                            <div class="symbol symbol-circle symbol-lg-5 d-none">
                                <img src="{{asset('dashboard/assets/media/users/300_1.jpg')}}" alt="image" />
                            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body text-center pt-4">
                        ...
                        <div class="mt-7">
                            <div class="symbol symbol-circle symbol-lg-75">
                                <img src="{{asset('dashboard/assets/media/users/300_11.jpg')}}" alt="image" />
                            </div>
