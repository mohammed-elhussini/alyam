            ...
            <div class="col-xl-4">
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body pt-4 d-flex flex-column justify-content-between">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
                                <div class="symbol symbol-lg-75">
                                    <img alt="Pic" src="{{asset('dashboard/assets/media/users/300_1.jpg')}}">
                                </div>
                        ...
                        <!--end::Info-->
                        <a href="{{route('view-contact')}}" class="btn btn-block btn-sm btn-light-warning font-weight-bolder text-uppercase py-4">view message</a>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Card-->
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body pt-4 d-flex flex-column justify-content-between">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            ...
                            <div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
                                <div class="symbol symbol-lg-75">
                                    <img alt="Pic" src="{{asset('dashboard/assets/media/users/300_10.jpg')}}">
                                </div>
                                <div class="symbol symbol-lg-75 symbol-primary d-none">
                                    <span class="font-size-h3 font-weight-boldest">JM</span>
                                </div>
                        ...
                        <!--end::Info-->
                        <a href="{{route('view-contact')}}" class="btn btn-block btn-sm btn-light-danger font-weight-bolder text-uppercase py-4">view message</a>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Card-->
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body pt-4 d-flex flex-column justify-content-between">
                        ...
                        <!--end::Info-->
                        <a href="{{route('view-contact')}}" class="btn btn-block btn-sm btn-light-primary font-weight-bolder text-uppercase py-4">view message</a>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Card-->
