                    ...
                    <form>
                        ...
                        <div class="card-body">
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="إسم الصفحة">
                            </div>
                            <div class="form-group w-100">
                            ...
                            <div class="form-group w-100">
                                <label class="card-label font-weight-bolder text-dark d-block">الصورة الأساسية</label>
