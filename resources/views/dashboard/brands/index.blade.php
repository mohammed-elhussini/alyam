    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">كل الماركات</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Info-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="symbol symbol-40 symbol-sm flex-shrink-0">
                                    <img src="{{$brand->image ? asset('storage/'.$brand->image) : asset('dashboard/assets/media/users/blank.png') }}">
                                </div>
                            </td>
                            <td>{{$brand->title}}</td>
